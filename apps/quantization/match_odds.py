...
class cal_match_odds(object):
    ...
    def full_time(self):
        ...
        dic={}
        #输出SOCCER_3WAY玩法
        dic['1005']=self.odds_tool_full_time.had()
        ...
        dic['1027'] = self.odds_tool_full_time.both_scored()

        #输出奇偶玩法赔率 SOCCER_ODD_EVEN_GOALS
        dic['1008']=self.odds_tool_full_time.odd_even()
